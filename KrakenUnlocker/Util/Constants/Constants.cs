...
{
    public const string Discord = @"https://discord.gg/JjsbtMJKnu";
    public const string GitHubUserUrl = @"https://github.com/9bry";
    public const string Instagram = @"https://instagram.com/nipp";
    public const string Telegram = @"https://t.me/br_yy";
    public const string EventsDocumentationUrl = @"https://github.com/9bry/KrakenUnlocker/blob/Main/Doc/Events.md";
}

struct AppBranding
{
    public const string Name = @"KrakenXboxUnlocker";
    public const string ShortName = @"KRAKEN";
    public const string IconResource = @"/Retro360.ico";
}
...
{
    public const string Zip = @"https://github.com/9bry/KrakenUnlocker/raw/Events-Data/Events.zip";
    public const string MetaUrl = @"https://raw.githubusercontent.com/9bry/KrakenUnlocker/Events-Data/meta.json";
}
